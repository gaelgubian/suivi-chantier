...
export class SignatureComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.signatureService
            ...
            .subscribe(
                (res: HttpResponse<ISignature[]>) => this.paginateSignatures(res.body, res.headers),
    ...
    trackId(index: number, item: ISignature) {
        return item.id;
    }
    ...
    private paginateSignatures(data: ISignature[], headers: HttpHeaders) {
