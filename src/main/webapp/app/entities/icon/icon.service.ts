...
type EntityResponseType = HttpResponse<IIcon>;
type EntityArrayResponseType = HttpResponse<IIcon[]>;
...
export class IconService {
    ...
    update(icon: IIcon): Observable<EntityResponseType> {
        return this.http.put<IIcon>(this.resourceUrl, icon, { observe: 'response' });
    }
