...
import fr.gubian.suivichantier.config.audit.AuditEventConverter;
import fr.gubian.suivichantier.domain.PersistentAuditEvent;
...
import static fr.gubian.suivichantier.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
