...
describe('Service Tests', () => {
    describe('Icon Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(IconService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/icons';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Icon', () => {
                service.create(new Icon(null)).subscribe(received => {
            ...
            it('should update a Icon', () => {
                service.update(new Icon(123)).subscribe(received => {
